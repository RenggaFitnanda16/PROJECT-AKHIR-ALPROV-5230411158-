...
kursor.execute("SELECT * FROM FAUNA WHERE jenis = 'Mamalia' AND jml_skrng <'1000'")
# Tampilkan dalam bentuk baris
baris_tabel = kursor.fetchall()
# membuat format table dengan method format
print("DATA FAUNA")
print("="*100)
print("{:<5} {:18} {:10} {:10} {:15} {:>20}".format("ID","Nama_Fauna","Jenis","Asal","Jumlah Saat Ini","Tahun Terakhir"))
print("-"*100)
